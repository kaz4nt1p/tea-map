        ...
        >
          ...
          >
            ...
            <div className="relative">
              {spot.image && (
                <div className="relative h-48 sm:h-56 md:h-64 bg-tea-100 rounded-t-2xl overflow-hidden flex items-center justify-center">
                  <img
                    src={spot.image}
                    alt={spot.name}
                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <motion.button
                      ...
                      className="px-3 sm:px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 text-sm sm:text-base w-full sm:w-auto flex justify-center items-center"
