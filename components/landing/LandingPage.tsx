...
const LandingPage = () => {
  ...
  const painPoints = [
    ...
    {
      icon: "📍",
      title: "Скрытые места чайной медитации",
  ...
  const steps = [
    {
      icon: "🗺️",
      title: "Найдите чайную медитацию",
  ...
  const testimonials = [
    ...
    },
    {
      ...
      text: "Вчера попробовала пуэр на берегу пруда - такая красота! Поделилась фото, и получила столько теплых откликов от других участников. Оказывается, у нас тут целое сообщество выросло!",
      rating: 5
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <Badge className="mb-4 bg-tea-100 text-tea-800 hover:bg-tea-200">
                🍃 Находите чайную медитацию • Записывайте сессии • Общайтесь
              </Badge>
              
              <h1 className="text-4xl md:text-6xl font-bold text-forest-900 mb-6 leading-tight">
                Убегите от городского шума и найдите 
                <span className="text-tea-600 block">своё место для чайной медитации</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  Найти своё место для чайной медитации
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-forest-600 leading-relaxed mb-4">
                    "Я просто обожаю пить чай на природе и обсуждать вкусы с друзьями. Мы ищем интересные места в лесу, у озер, в парках - везде, где можно устроить настоящую чайную сессию. 
                    Tea Map помогает находить и делиться такими особенными местами с сообществом единомышленников."
                  </p>
