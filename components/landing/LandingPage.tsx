...
const LandingPage = () => {
  ...
  const painPoints = [
    ...
    {
      icon: "☕",
      title: "Одинокие чайные сессии",
      description: "Ваши вкусовые открытия и медитативные моменты остаются только с вами. Нет возможности поделиться впечатлениями от любимого чая или узнать мнение других ценителей."
    },
    {
      icon: "📍",
      title: "Скрытые места покоя",
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-forest-600 leading-relaxed mb-4">
                    ...
                    Tea Map объединяет людей через общую любовь к чаю и помогает находить покой в нашем шумном мире."
                  </p>
